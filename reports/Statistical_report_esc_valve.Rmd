...
TO DO: Forestplots? One presenting crud, one adjusted. I still think ok with ALL variables in Foresplot. 
...
but where the other valve is included in (so patients with MR can have TR and vice versa) 
for important valve variables. No adjustment is performed. Imputation is not performed. 

TO DO: Forestplots? Vad är murmur??? Vilken variabel?
