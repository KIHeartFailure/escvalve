...
Performed using logistic regression (one for combined MR vs No VHD, 
one for TR vs No VHD, one for MR+TR vs No VHD). Variables included in the model are those presented in the table/Forest plot.
...
hazards and where as a results included as strata variables in the cox regression model.
