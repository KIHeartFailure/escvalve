...
```{r, child = "./src/tabvalve.Rmd"}
```

There are 2 EF variables (Last know and according to Echo-Doppler). 
More missing for the latter. Could use Echo-Doppler and if missing use last known throughout (also in models)?
...
If you prefer in a Forestplot I can remove table and present only the adjusted OR in a forestplot. 
